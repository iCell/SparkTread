    ...
    public static let provisional = WeaponRuleset(
        weapons: [
            WeaponDefinition(
                ...
                cooldownTicks: [30, 26, 22, 18], maxActive: [1, 1, 2, 2],
            ...
            WeaponDefinition(
                ...
                cooldownTicks: [45, 40, 35, 30], maxActive: [6, 8, 10, 12],
            ...
            WeaponDefinition(
                ...
                initialSpeedSubunitsPerTick: [96, 96, 112, 128],
                accelerationSubunitsPerTick2: [16, 20, 24, 32],
                maxSpeedSubunitsPerTick: [640, 704, 832, 960],
                lifetimeTicks: [600, 600, 600, 600],
            ...
            WeaponDefinition(
                ...
                initialSpeedSubunitsPerTick: [96, 96, 112, 128],
                accelerationSubunitsPerTick2: [8, 8, 12, 16],
                maxSpeedSubunitsPerTick: [384, 416, 448, 512],
                lifetimeTicks: [600, 600, 600, 600],
